...
import { Home, Heart, Calendar, Brain, MessageCircle, FileText, Users, BookOpen, Target, Mail, HelpCircle } from 'lucide-react';
      ...
      <nav className="bg-white border-b border-[#266CA9]/20 sticky top-[72px] z-40 shadow-sm">
        <div className="container mx-auto px-4">
          <div className="flex gap-2 overflow-x-auto py-2 scrollbar-hide">
            ...
            <NavButton icon={<Mail className="w-4 h-4" />} label="Surat untuk Diri" value="letter" active={activeTab === 'letter'} onClick={() => setActiveTab('letter')} />
